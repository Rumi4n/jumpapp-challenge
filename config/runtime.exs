...
#
#     PHX_SERVER=true bin/jumpapp_email_sorter start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :jumpapp_email_sorter, JumpappEmailSorterWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :jumpapp_email_sorter, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :jumpapp_email_sorter, JumpappEmailSorter.Mailer,
